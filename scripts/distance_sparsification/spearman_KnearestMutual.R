...
#knn_adj_matrix <- create_mutual_knn_graph(as.matrix(distancematrix), k = 9) # Data set 1
knn_adj_matrix <- create_mutual_knn_graph(as.matrix(distancematrix), k = 8) # Data set 2
